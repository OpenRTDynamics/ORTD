...
thispath = get_absolute_file_path('benchmark.sce');
cd(thispath);
...
save_irparam(par, 'benchmark.ipar', 'benchmark.rpar');
...
// optionally execute
messages = unix_g(ORTD.ortd_executable+' -s benchmark -i 901 -l 1000');
