...
#include <memory.h>
#include <string.h>
#include "/opt/scilab-4.1.2/routines/machine.h"
#include "/opt/scilab-4.1.2/routines/os_specific/link.h"
#include "/opt/scilab-4.1.2/routines/scicos/scicos.h"
...
{
      printf("scicos compfn called flag = %d\n", flag);
  ...
  if (flag != 4 && flag != 6 && flag != 5){
    reentryflag=(int*) ((scicos_block *)(*block->work)+7);
    if (*reentryflag==0){
      *reentryflag=1;
      ...
      block_SuperBlock[1].inptr[0]  = SuperBlock_block_outtbptr[4];
      block_SuperBlock[1].outptr[0] = SuperBlock_block_outtbptr[1];
      ...
      block_SuperBlock[2].outptr[0] = SuperBlock_block_outtbptr[4];
      ...
      /* set blk struc. of 'summation' (type 4 - blk nb 7) */
      block_SuperBlock[6].inptr[0]  = SuperBlock_block_outtbptr[0];
      block_SuperBlock[6].inptr[1]  = SuperBlock_block_outtbptr[1];
      block_SuperBlock[6].outptr[0] = SuperBlock_block_outtbptr[2];
      block_SuperBlock[6].z         = &(z[1]);
      block_SuperBlock[6].x         = &(zero);
      block_SuperBlock[6].xd        = w;
      block_SuperBlock[6].g         = &(zero);
      block_SuperBlock[6].ipar      = &(ipar[5]);
      block_SuperBlock[6].work      = (void **)(((double *)work)+6);
    }
  }
  ...
  if (flag == 1) { /* Output computation */
    switch (nevprt) {
      case 1 : /* Blocks activated on the event number 1 */
        ...
        /* Call of 'summation' (type 4 - blk nb 7) */
        block_SuperBlock[6].nevprt = 2;
        local_flag = 1;
        summation(&block_SuperBlock[6],local_flag);
        if(local_flag < 0) return(5 - local_flag);
    ...
    if ((*block->work=scicos_malloc(sizeof(scicos_block)*7+sizeof(int)))== NULL) return 0;
    reentryflag=(int*) ((scicos_block *)(*block->work)+7);
    *reentryflag=0;
    block_SuperBlock=(scicos_block*) *block->work;
    ...
    /* set blk struc. of 'summation' (type 4 - blk nb 7) */
    block_SuperBlock[6].type   = 4;
    block_SuperBlock[6].ztyp   = 0;
    block_SuperBlock[6].ng     = 0;
    block_SuperBlock[6].nx     = 1;
    block_SuperBlock[6].x      = &(zero);
    block_SuperBlock[6].xd     = w;
    block_SuperBlock[6].g      = &(zero);
    block_SuperBlock[6].nz     = 0;
    block_SuperBlock[6].noz    = 0;
    block_SuperBlock[6].nrpar  = 0;
    block_SuperBlock[6].nopar  = 0;
    block_SuperBlock[6].nipar  = 2;
    block_SuperBlock[6].nin    = 2;
    block_SuperBlock[6].nout   = 1;
    block_SuperBlock[6].nevout = 0;
    block_SuperBlock[6].nmode  = 0;
    if ((block_SuperBlock[6].evout  = calloc(block_SuperBlock[6].nevout,sizeof(double)))== NULL) return 0;
    if ((block_SuperBlock[6].insz   = malloc(3*sizeof(int)*block_SuperBlock[6].nin))== NULL) return 0;
    if ((block_SuperBlock[6].inptr  = malloc(sizeof(void *)*block_SuperBlock[6].nin))== NULL) return 0;
    block_SuperBlock[6].inptr[0]  = SuperBlock_block_outtbptr[0];
    block_SuperBlock[6].inptr[1]  = SuperBlock_block_outtbptr[1];
    block_SuperBlock[6].insz[0]   = 1;
    block_SuperBlock[6].insz[1]   = 1;
    block_SuperBlock[6].insz[2]   = 1;
    block_SuperBlock[6].insz[3]   = 1;
    block_SuperBlock[6].insz[4]   = SCSREAL_N;
    block_SuperBlock[6].insz[5]   = SCSREAL_N;
    if ((block_SuperBlock[6].outsz  = malloc(3*sizeof(int)*block_SuperBlock[6].nout))== NULL) return 0;
    if ((block_SuperBlock[6].outptr = malloc(sizeof(void*)*block_SuperBlock[6].nout))== NULL) return 0;
    block_SuperBlock[6].outptr[0] = SuperBlock_block_outtbptr[2];
    block_SuperBlock[6].outsz[0]  = 1;
    block_SuperBlock[6].outsz[1]  = 1;
    block_SuperBlock[6].outsz[2]  = SCSREAL_N;
    block_SuperBlock[6].z         = &(z[1]);
    block_SuperBlock[6].ipar      = &(ipar[5]);
    block_SuperBlock[6].work      = (void **)(((double *)work)+6);
    block_SuperBlock[6].nevprt    = nevprt;
