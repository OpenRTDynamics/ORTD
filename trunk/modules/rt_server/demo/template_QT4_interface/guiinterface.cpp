    ...
    ui(new Ui::GuiInterface)
{
    ...
    qt_event_com->scope_ref_data = new QPL_ScopeData(2,0.01,tr("1"),QStringList("1") << "2");
    ...
    qt_event_com->scope_actuating_data = new QPL_ScopeData(1,0.01,tr("1"),QStringList("1"));
